import { Button, Typography, Tabs, Modal } from "antd";
...
const ModalProduct = ({ setOpenModalProduct, openModalProduct }) => {
  ...
  //   const handleClickModalProductClose = () => {
  ...
  return (
    <Modal open={openModalProduct} onCancel={() => setOpenModalProduct(false)}   onOk={() => setOpenModalProduct(false)}>
      <div
